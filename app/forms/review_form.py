...
class ReviewForm(FlaskForm):
    ...
    user_img = FileField("Image from User", validators=[FileRequired(), FileAllowed(["pdf", "png", "jpg", "jpeg", "gif"])]) #might be able to change "User" to reflect username or user.id
