...
def seed_spot_images():
    ...
    SpotImage(spot_id=4, img_url="https://i.imgur.com/7trXace.jpeg", preview=True),
    SpotImage(spot_id=5, img_url="https://i.imgur.com/OHHys0c.png", preview=True),
    SpotImage(spot_id=6, img_url="https://i.pinimg.com/736x/7b/45/d1/7b45d1b46b888501efac0615afe2c0f5.jpg", preview=True),
